...
public class SerialTestArduino implements SerialPortEventListener {
  SerialPort serialPort;
  static int message=1;
  public static void main(String[] args) throws Exception {
    SerialTestArduino main = new SerialTestArduino();
    main.initialize();
    Thread t = new Thread() {
      public void run() {
  ...
  private static final String PORT_NAMES[] = { 
                  ...
                  "/dev/ttyUSB0", // Linux
                  "COM4", // Windows: Note: check port number match with Arduino
  };
